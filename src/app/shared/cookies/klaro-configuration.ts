  ...
  */
  translations: {
    ...
    ar: {
      ...
      poweredBy: 'cookies.consent.powered-by',
      privacyPolicy: {
          name: 'cookies.consent.content-modal.privacy-policy.name',
          text: 'cookies.consent.content-modal.privacy-policy.text'
      },
      ...
      purposeItem: {
        service: 'cookies.consent.app.service',
        services: 'cookies.consent.app.services'
      },
      service: {
        required: {
          description: 'cookies.consent.app.required.description',
        ...
        purpose: 'cookies.consent.service.purpose',
        purposes: 'cookies.consent.service.purpose.purposes'
      }
    },
    /**kware end editing */
  },
